...
//Funciones para Calculadora de Modelos matemáticos lineales
...
//Funciones y declaración de constantes para Calculadora de Temperatura de Equilibrio:
...
int main() {
    ...
    printf("\nEste programa calcula la temperatura de equilibrio termico\n");
    ...
    if (opcion_principal == 1) {
        ...
        printf("\nOpcion invalida. Saliendo del programa.\n");
    }
